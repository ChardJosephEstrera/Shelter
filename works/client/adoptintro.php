...
<body>
    ...
    <ul class="Values list-unstyled text-center">
        <li class="list-group-item px-5 m-3 fs-5 py-5"><strong>1.</strong>: Age: Must be of legal age (usually 18+).</li>
        <li class="list-group-item px-5 m-3 fs-5 py-5"><strong>2.</strong>: Safe and suitable living conditions.</li>
        <li class="list-group-item px-5 m-3 fs-5 py-5"><strong>3.</strong>: Ability to afford pet care (food, vet visits).</li>
        <li class="list-group-item px-5 m-3 fs-5 py-5"><strong>4.</strong>: Willingness to dedicate time for care and companionship.</li>
        <li class="list-group-item px-5 m-3 fs-5 py-5"><strong>5.</strong>: Proof of ability to provide necessary health care.</li>
    </ul>
</div>
